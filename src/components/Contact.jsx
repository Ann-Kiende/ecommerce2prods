        ...
        <div className='dropdown'>
          <Dropdown
            ...
            list={[
              ...
              'Click <strong>TRACK MY ITEM</strong> button in front of the order you wish to track',
          ...
          <Dropdown
            ...
            list={[
              'From the list of Orders in your Jumia Account, Click SEE DETAILS in front of the order you wish to cancel.',
